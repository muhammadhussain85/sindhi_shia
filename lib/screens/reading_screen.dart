...
class ReadingScreen extends StatefulWidget {
  ...
  const ReadingScreen({super.key, required this.sectionId, required this.sectionTitle, this.initialSearchQuery, this.initialScrollIndex});
...
class _ReadingScreenState extends State<ReadingScreen> {
  ...
  void dispose() {
    ...
    Get.find<SettingsController>().saveLastReadSahifa(widget.sectionId, widget.sectionTitle, index: currentIndex);
  ...
  Future<void> _loadParagraphs() async {
    final data = await DBHelper.getParagraphs(widget.sectionId);
    if (mounted) {
      setState(() {
        _allParagraphs = data;
      ...
      if (widget.initialScrollIndex != null) {
        ...
        final lastRead = Get.find<SettingsController>().lastReadSahifa;
      ...
      Get.find<SettingsController>().saveLastReadSahifa(widget.sectionId, widget.sectionTitle, index: _initialIndex);
                    ...
                    child: Directionality(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Obx(() {
                            final String uniqueId = "sahifa_${widget.sectionId}_${parag['ID'] ?? index}";
                            final bool isSaved = settings.isBookmarked('sahifa', uniqueId);
                            return IconButton(
                              ...
                              tooltip: "محفوظ ڪريو",
                              onPressed: () => settings.toggleBookmark('sahifa', uniqueId, widget.sectionTitle, arabic, translation),
                            );
                          }),
